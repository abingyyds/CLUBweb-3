      ...
      <DialogContent className="w-[90vw] md:w-[640px] bg-[#f2eaff] border-none rounded-[30px] p-0 gap-0">
        <div className="flex flex-col px-6 md:px-[60px] py-[40px] gap-5">
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* 会员类型列表 */}
            <div className="text-[#E33335] text-base font-bold leading-relaxed">
            ...
            <div className="flex gap-5 mt-0">
              <DialogClose asChild>
                <Button
                  variant="ghost"
                  className="flex-1 bg-[#E33335] hover:bg-[#E33335]/90  text-white text-sm font-bold rounded-[30px] h-auto py-[10px] px-[20px]"
              ...
              <Button
                onClick={onConfirm}
                className="flex-1 bg-[#E33335] hover:bg-[#E33335]/90  text-white text-sm font-bold rounded-[30px] h-auto py-[10px] px-[20px] flex items-center justify-center gap-[5px]"
                style={{ letterSpacing: "-0.14px", lineHeight: "17px" }}
              >
                Confirm
