...
export const MemberModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="w-[90vw] md:w-[640px] bg-[#252525] border-none rounded-[40px] p-0 gap-0">
        <div className="flex flex-col px-6 md:px-[60px] py-[40px] gap-5">
          {/* 标题 */}
          <DialogHeader className="p-0">
            <DialogTitle className="text-white text-[24px] font-bold text-center leading-[26px] uppercase">
              Alert
            </DialogTitle>
          </DialogHeader>
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* 会员类型列表 */}
            <div className="text-[#f3ba2f] text-base font-bold leading-relaxed">
            ...
            <div className="flex gap-5 mt-0">
              <DialogClose asChild>
                <Button
                  variant="ghost"
                  className="flex-1 bg-[#f49f00] hover:bg-[#f49f00]/90 text-black text-base font-normal rounded-[16px] h-[43px] py-4 px-6 uppercase"
                  style={{ letterSpacing: "0", lineHeight: "19px" }}
                >
                  Cancel
                </Button>
              </DialogClose>
